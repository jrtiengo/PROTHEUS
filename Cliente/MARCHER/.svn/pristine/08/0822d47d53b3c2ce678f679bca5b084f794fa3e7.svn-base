...
User Function MTA260MNU()
	...
	Local cRot_BLQMT260		 :=  SuperGetMV( "MA_BQMT260",, "A260Inclui/A260Estorn" ) // Rotinas Bloqueadas do Menu
	...
	If !(cCodUsr $ cUsrPermitidos)
		...
		x:= 1
		While  x <=  nTam
			If aRotina [x][X_ROTINA]  $ cRot_BLQMT260  // Busca Rotinas para retirar do menu  //aScan(aRotina, {|x| AllTrim( X[X_ROTINA] ) == "A240Inclui" } )
