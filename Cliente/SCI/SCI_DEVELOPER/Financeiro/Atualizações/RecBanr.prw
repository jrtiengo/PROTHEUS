...
ฑฑณFun…o    ณ RECBANR  ณ Autor ณ R.H. 			      ณ Data ณ 02.10.2019 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Emissao do Recibos de Pagamento Eletronico BCO BANRISUL    ณฑฑ
...
Private nHdl   := 0
PRIVATE nSeq_  := 0
Private Titulo := "GERAวรO DE ARQUIVO BANRISUL P/RECIBOS DE PAGAMENTOS"
Private GERAOK
Private aPerAberto	:= {}
Private aPerFechado	:= {}
Private cMes 	:= ''
...
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
@ 000,000 TO 250,500 DIALOG GERAOK TITLE OemToAnsi("Gera็ใo Holerite Eletronico - Bco Banrisul")

@ 030,010 SAY OemtoAnsi('Este programa fara a gera็ใo do arquivo magnetico para envio ')
@ 040,010 SAY OemtoAnsi('ao Banco Banrisul para disponibiliza็ใo do Holerite Eletronico ')
...
//ณ                                ณ
//ณ01 Pagamento Mensal             ณ
//ณ02 Folha Complementar           ณ
//ณ03 13 Salario                   ณ
//ณ04 Abono                        ณ
//ณ05 Outras Folhas                ณ
//ณ06 Outros                       ณ
...
aAdd( aTipo0, { 'TIPO DE REGISTRO                     ', 001, 002,   'C',   2,  0, '"00"' } )
aAdd( aTipo0, { 'BANCO                                ', 003, 005,   'C',   3,  0, '"041"' } )
aAdd( aTipo0, { 'ANO COMPETENCIA                      ', 006, 009,   'N',   4,  0, 'Subs( MV_PAR03,1,4 )' } )
aAdd( aTipo0, { 'MES COMPETENCIA                      ', 010, 011,   'N',   2,  0, 'Subs( MV_PAR03,5,2)' } )
aAdd( aTipo0, { 'DIA DA COMPETENCIA                   ', 012, 013,   'C',   2,  0, '"30"' } )
aAdd( aTipo0, { 'IDENTIDADE DO CONVENIO               ', 014, 031,   'C',  18,  0, 'Space(18)' } )
aAdd( aTipo0, { 'DATA DE GRAVACAO Formato: AAAAMMDD   ', 032, 039,   'N',   8,  0, 'Dtos(DATE())' } )
aAdd( aTipo0, { 'NSA                                  ', 040, 043,   'N',   4,  0, 'Subs( MV_PAR18,1,4)  ' } )
aAdd( aTipo0, { 'ORGAO PAGADOR                        ', 044, 055,   'C',  12,  0, '"INTER       "' } )
aAdd( aTipo0, { 'BRANCO                               ', 056, 056,   'C',   1,  0, '" "' } )
aAdd( aTipo0, { 'CODIGO DA EMPRESA                    ', 057, 062,   'N',   6,  0, '790305' } )
aAdd( aTipo0, { 'CODIGO CONVENIO                      ', 063, 065,   'N',   3,  0, '001' } ) 
aAdd( aTipo0, { 'BRANCOS                              ', 066, 066,   'C',   1,  0, 'Space(1)  ' } )
aAdd( aTipo0, { 'TIPO DE FOLHA                        ', 067, 068,   'N',   2,  0, 'cCodRec  ' } )    
aAdd( aTipo0, { 'BRANCO                               ', 069, 070,   'C',   2,  0, 'Space(2)' } )
aAdd( aTipo0, { 'LAYOUT                               ', 071, 072,   'N',   2,  0, 'Space(2)' } )
aAdd( aTipo0, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )

// Registro Header do Comprovante - TIPO 1
aTipo1 := {}
//              Descricao                                Ini  Fim   Tipo  Tam Dec  Conteudo
aAdd( aTipo1, { 'TIPO DE REGSITRO                     ', 001, 002,   'N',   2,  0, '"10"' } )
aAdd( aTipo1, { 'AGENCIA                              ', 003, 006,   'N',   4,  0, 'Subs( SRA->RA_BCDEPSA, 5, 4 )' } )  
aAdd( aTipo1, { 'NฺMERO DA CONTA DO FUNCIONมRIO       ', 007, 017,   'N',  10,  0, 'cCtaFunc' } )
aAdd( aTipo1, { 'MATRICULA                            ', 018, 023,   'C',   6,  0, 'SRA->RA_MAT' } )
aAdd( aTipo1, { 'BRANCOS                              ', 024, 032,   'C',  10,  0, 'Space(10)' } )
aAdd( aTipo1, { 'NOME DO FUNCIONมRIO                  ', 033, 067,   'C',  35,  0, 'SRA->RA_NOME' } )
aAdd( aTipo1, { 'BRANCOS                              ', 068, 072,   'C',   5,  0, 'Space(5)' } )
aAdd( aTipo1, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )

// Registro Detalhes do Comprovante - TIPO 2
aTipo2 := {}
//              Descricao                                Ini  Fim   Tipo  Tam Dec  Conteudo
aAdd( aTipo2, { 'TIPO DE REGISTRO                     ', 001, 003,   'N',   3,  0, '"200"' } )
aAdd( aTipo2, { 'CำDIGO DE LANวAMENTO                 ', 004, 006,   'C',   3,  0, 'cCodLan' } ) 
aAdd( aTipo2, { 'ESPACO                               ', 007, 007,   'C',   1,  0, 'Space(1)' } ) 
aAdd( aTipo2, { 'DESCRIวรO DE LANวAMENTO              ', 008, 027,   'C',  20,  0, 'cDescLan' } )
aAdd( aTipo2, { 'REFERENCIA DO LANวAMENTO             ', 028, 039,   'C',  11,  0, '(Transform(nRefLan, "@E 999.99"))' } )
aAdd( aTipo2, { 'VALOR DO LANวAMENTO                  ', 040, 050,   'C',  12,  0, 'PadL(TRANSFORM(nValLan, "@E 999,999.99"),12)' } )    
//aAdd( aTipo2, { 'ESPACOS                              ', 051, 053,   'C',   3,  0, 'Space(3)' } )  
//aAdd( aTipo2, { 'IDENTIFICADOR DE LANวAMENTO          ', 039, 039,   'N',   1,  0, 'cIdLan' } )
//aAdd( aTipo2, { 'FILLER                               ', 040, 237,   'C', 198,  0, '  ' } )
//aAdd( aTipo2, { 'RESERVADO                            ', 238, 246,   'C',   9,  0, '  ' } )
aAdd( aTipo2, { 'BRANCOS                              ', 051, 072,   'C',  22,  0, 'Space(22)' } )
aAdd( aTipo2, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )

// Registro Detalhes do Comprovante - TIPO 21
aTipo21 := {}
aAdd( aTipo21, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   2,  0, '20' } )  
aAdd( aTipo21, { 'BRANCOS                              ', 003, 072,   'C',  70,  0, 'Space(70)' } )
aAdd( aTipo21, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )

// Registro Detalhes do Comprovante - TIPO 22 - SPORT CLUB INTERNACIONAL
aTipo22 := {}
aAdd( aTipo22, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   2,  0, '20' } )
aAdd( aTipo22, { 'TIPO DE REGISTRO                     ', 003, 050,   'C',  47,  0, '"SPORT CLUB INTERNACIONAL DEMOSTRAT.DE PAGAMENTO"' } )
aAdd( aTipo22, { 'BRANCOS                              ', 051, 072,   'C',  23,  0, 'Space(23)' } )
aAdd( aTipo22, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } ) 

// Registro Detalhes do Comprovante - TIPO 23 - MATRICULA E NOME
aTipo23 := {}
aAdd( aTipo23, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   2,  0, '20' } )
aAdd( aTipo23, { 'MATRICULA                            ', 003, 008,   'C',   6,  0, 'SRA->RA_MAT' } )
aAdd( aTipo23, { 'BRANCOS                              ', 009, 010,   'C',   2,  0, 'Space(2)' } )   
aAdd( aTipo23, { 'NOME                                 ', 011, 042,   'C',  30,  0, 'SRA->RA_NOME' } )
aAdd( aTipo23, { 'BRANCOS                              ', 043, 072,   'C',  32,  0, 'Space(32)' } ) 
aAdd( aTipo23, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )  

// Registro Detalhes do Comprovante - TIPO 24 - COMPETENCIA
aTipo24 := {}
aAdd( aTipo24, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   2,  0, '20' } )
aAdd( aTipo24, { 'COMPETENCIA TEXTO                    ', 003, 008,   'C',  12 , 0, '"COMPETENCIA:"' } )
aAdd( aTipo24, { 'COMPETENCIA                          ', 014, 021,   'C',   8,  0, 'MV_PAR03' } )
aAdd( aTipo24, { 'BRANCOS                              ', 022, 072,   'C',  50,  0, 'Space(50)' } )   
aAdd( aTipo24, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )   

// Registro Detalhes do Comprovante - TIPO 25 - CARGO E ADMISSAO
aTipo25 := {}
aAdd( aTipo25, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   2,  0, '20' } )
aAdd( aTipo25, { 'CARGO TEXTO                          ', 003, 008,   'C',   6 , 0, '"CARGO:"' } )
aAdd( aTipo25, { 'CARGO                                ', 009, 028,   'C',  20,  0, 'fDesc("SRJ",SRA->RA_CODFUNC,"RJ_DESC")' } )
aAdd( aTipo25, { 'BRANCOS                              ', 029, 030,   'C',   2,  0, 'Space(1)' } )   
aAdd( aTipo25, { 'DATA ADMISSAO                        ', 031, 038,   'D',  12 , 0, 'SRA->RA_ADMISSA' } )
aAdd( aTipo25, { 'BRANCOS                              ', 039, 072,   'C',  32,  0, 'Space(32)' } )  
aAdd( aTipo25, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )   

// Registro Mensagem do Comprovante - TIPO 3   - NAO UTILIZADO
aTipo3 := {}
//              Descricao                                Ini  Fim   Tipo  Tam Dec  Conteudo
aAdd( aTipo3, { 'TIPO DE REGISTRO                     ', 001, 002,   'C',   2,  0, '"20"' } )
aAdd( aTipo3, { 'MATRICULA                            ', 003, 008,   'C',   6,  0, 'SRA->RA_MAT' } )
//aAdd( aTipo3, { 'FILLER                               ', 042, 236,   'C', 195,  0, '  ' } )
//aAdd( aTipo3, { 'RESERVADO                            ', 237, 245,   'C',   9,  0, '  ' } )
aAdd( aTipo3, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'C',   8,  0, 'nSeq_' } )

// Registro Trailler do Comprovante TIPO 4 - NAO UTILIZADO
aTipo4 := {}
//              Descricao                                Ini  Fim   Tipo  Tam Dec  Conteudo
//aAdd( aTipo4, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   1,  0, '"99"' } )
...
// Registro Trailler do Comprovante TIPO 5  - NAO UTILIZADO
aTipo5 := {}
//              Descricao                                Ini  Fim   Tipo  Tam Dec  Conteudo
...
aTipo9 := {}
//              Descricao                                Ini  Fim   Tipo  Tam Dec  Conteudo
aAdd( aTipo9, { 'TIPO DE REGISTRO                     ', 001, 002,   'N',   2,  0, '"99"' } )
aAdd( aTipo9, { 'TOTAL DE REGISTROS DO LOTE           ', 003, 008,   'N',   6,  0, 'nQtdComp' } )
aAdd( aTipo9, { 'TOTAL DE REGISTROS DO ARQUIVO        ', 009, 016,   'N',   8,  0, 'nTotRLote' } )
aAdd( aTipo9, { 'BRANCOS                              ', 017, 072,   'C',  56,  0, 'Space(56)' } )
aAdd( aTipo9, { 'SEQUENCIAL DO ARQUIVO                ', 073, 080,   'N',   8,  0, 'nSeq_' } )
...
While SRA->(!EOF()) .AND. &cInicio <= cFim
	...
	// Se o funcionario nao tiver conta no BANRISUL nao envia
	If Subs( SRA->RA_BCDEPSAL, 1, 3 ) <> '041'
		SRA->( dbSkip() )
		Loop
	EndIf
...
cCtaFunc   := SubStr( SRA->RA_CTDEPSA, 3, 10  )
...
For nI := 1 To 2
	...
	If  nI == 1
//		cCodLan    := ''
		cDescLan   := 'Total Proventos:'
		cIdLan     := 2
		nValLan    := TOTVENC
	Else
//		cCodLan    := ''
		cDescLan   := 'Total Descontos:'
		cIdLan     := 4
		nValLan    := TOTDESC
	EndIf
...
Static Function GeraBDN21()
nSeq_++
FWrite( nHdl, GeraLinhas( aTipo21 ) )
nTotRLote++
Return NIL

Static Function GeraBDN22()
nSeq_++
FWrite( nHdl, GeraLinhas( aTipo22 ) )
nTotRLote++
Return NIL   

Static Function GeraBDN23()
nSeq_++
FWrite( nHdl, GeraLinhas( aTipo23 ) )
nTotRLote++
Return NIL    

Static Function GeraBDN24()
nSeq_++
FWrite( nHdl, GeraLinhas( aTipo24 ) )
nTotRLote++
Return NIL    

Static Function GeraBDN25()
nSeq_++
FWrite( nHdl, GeraLinhas( aTipo25 ) )
nTotRLote++
Return NIL
