...
User Function M42ENVPC()
	...
	Local lSendMail := .F.
	Local oDlg2, oFont, oTxtPedido, oPedido, oTxtPara, oEmail, oTxtCopia, oCopia, oTxtAssunto, oAssunto, oCorpoEmail
	...
	Begin Sequence
		...
		For nPedido := 1 To Len( aPedidos )
			...
			@ 230,270 BUTTON "Sair"   Size 037,010 of oDlg2 Pixel Action(lSendMail := .F., MsgAlert("Cancelado o envio de e-mail pelo usuário"), oDlg2:End())
