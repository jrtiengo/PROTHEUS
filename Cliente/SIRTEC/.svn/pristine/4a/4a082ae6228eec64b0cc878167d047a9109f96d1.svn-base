                    ...
                    IF ( !LDFERAVI )
                        ...
                        IF ( ( ( GETMEMVAR("RG_DFERPRO") == 0 .AND. LNOPERDPER ) .OR. ( ( GETMEMVAR("RG_DFERPRO") == NDFERIND ) .AND. NFALPRO <= 5 ) ) .AND. NDFERIND > 0 )
                            ...
                            IF ( EMPTY(ACODFOL[252,1]) )
                                ...
                                NBASFER := SALARIO + NINTPERCUL - ( FBUSCAPD("140,147,148",'V',,,)*0.30) + NADTSERV + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NMEDFERV + NGTAREFFV
    
                                IF ( SRA->RA_CATFUNC == "H" .AND. LHOJORVA )
    
                                    NBASFER := NSALMESFV + NINTPERCUL -( FBUSCAPD("140,147,148",'V',,,)*0.30) + NADTSERV + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NMEDFERV + NGTAREFFV
                            ...
                            IF ( !EMPTY(ACODFOL[252,1]) )
                                ...
                                NBASFER := SALARIO + NINTPERCUL -( FBUSCAPD("140,147,148",'V',,,)*0.30) + NADTSERV + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NGTAREFFV
    
                                IF ( SRA->RA_CATFUNC == "H" .AND. LHOJORVA )
    
                                    NBASFER := NSALMESF + NINTPERCUL -( FBUSCAPD("140,147,148",'V',,,)*0.30) + NADTSERV + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NGTAREFFV
                    ...
                    IF ( LEN(APERFERIAS) > 0 )
                        ...
                        While ( NCONT <= LEN(APERFERIAS) )
                            ...
                            IF ( APERFERIAS[NCONT,3] > 0 )
                                ...
                                NFERVAUX := (((SALARIO + NINTPERCUL -( FBUSCAPD("140,147,148",'V',,,)*0.30) + NADTSERV + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV+NGTAREFFV) / P_QTDIAMES) * NFERDAUX)
    
                                IF ( SRA->RA_CATFUNC == "H" .AND. LHOJORVA )
    
                                    NFERVAUX := (((NSALMESFV + NINTPERCUL -( FBUSCAPD("140,147,148",'V',,,)*0.30) + NADTSERV + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV+NGTAREFFV) / P_QTDIAMES) * NFERDAUX)
                    ...
                    IF ( !LDFERAVI )
                        ...
                        IF ( ( ( GETMEMVAR("RG_DFERPRO") == 0 .AND. LNOPERDPER ) .OR. ( ( GETMEMVAR("RG_DFERPRO") == NDFERIND ) .AND. NFALPRO <= 5 ) ) .AND. NDFERIND > 0 )
                            ...
                            IF ( EMPTY(ACODFOL[252,1]) )
                                ...
                                NBASFER := SALARIO + NADTSERV + NINTPERCUL + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NMEDFERV + NGTAREFFV + FINCSEMID("0086")
    
                                IF ( SRA->RA_CATFUNC == "H" .AND. LHOJORVA )
    
                                    NBASFER := NSALMESFV + NADTSERV + NINTPERCUL + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NMEDFERV + NGTAREFFV
                            ...
                            IF ( !EMPTY(ACODFOL[252,1]) )
                                ...
                                NBASFER := SALARIO + NADTSERV + NINTPERCUL + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NGTAREFFV + FINCSEMID("0086")
    
                                IF ( SRA->RA_CATFUNC == "H" .AND. LHOJORVA )
    
                                    NBASFER := NSALMESF + NADTSERV + NINTPERCUL + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV + NGTAREFFV
                        ...
                        While ( NCONT <= LEN(APERFERIAS) )
                            ...
                            IF ( APERFERIAS[NCONT,3] > 0 )
                                ...
                                IF ( !LADCSRESC .OR. (CCOMPL == "S" .AND. !LTEMIDRESC) )
                                    ...
                                    NFERVAUX := (((SALARIO + NADTSERV + NINTPERCUL + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV+NGTAREFFV + FINCSEMID("0086")) / P_QTDIAMES) * NFERDAUX)
    
                                    IF ( SRA->RA_CATFUNC == "H" .AND. LHOJORVA )
    
                                        NFERVAUX := (((NSALMESFV + NADTSERV + NINTPERCUL + NINTINSAL + NADCCONF + NADCTRF + NGCOMISFV+NGTAREFFV) / P_QTDIAMES) * NFERDAUX)
