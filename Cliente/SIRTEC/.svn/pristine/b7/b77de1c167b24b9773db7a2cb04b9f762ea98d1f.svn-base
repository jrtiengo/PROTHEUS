...
//                      cSqx += "  FROM " + RetSqlName("SRA") + " SRA "
                     ...
                     Else
                        @ nLin,001 psay Substr(TSCP2->CP_PRODUTO,01,06)
                        // Ajuste para tamanho 48, estava empurrando os dados na segunda pagina.
                        @ nLin,019 psay Substr(Posicione("SB1",1,xfilial("SB1") + TSCP2->CP_PRODUTO,"B1_DESC"),1,48)
