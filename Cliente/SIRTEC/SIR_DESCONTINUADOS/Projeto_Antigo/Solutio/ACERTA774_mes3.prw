...
User Function ACERTA774()
	...
	Local cQuery	:= {}
	Local cData		:= "201903" // Período da folha.
	Local cVerb1	:= "701"	// Verba 1.
	Local cVerb2	:= "702"	// Verba 2.
	Local cVerb3	:= "707"	// Verba 3.
	Local cVerb4	:= "774"	// Verba a ser atualizado o valor.
	Local nPerc		:= 0.030399	// Percentual a ser aplicado nos valores das verbas 701 , 702 e 707.
	...
	Do While !EOF()
		...
		// Filtra por funcionário, a soma das alíquotas 701,702 e 707.
		...
		cQuery += " AND (RR_PD = '"+ cVerb1 +"' OR RR_PD = '"+ cVerb2 +"' OR RR_PD = '"+ cVerb3 +"') "
