...
/*/
//--------------------------------------------------------------------
User Function UPDCAUC( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDCAUC" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDCAUC" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt. Contrato'															, ; //X3_TITULO
	'Dt. Contrato'															, ; //X3_TITSPA
	'Dt. Contrato'															, ; //X3_TITENG
...
PutHelp( "PA1_DTCONTR", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "A1_DTCONTR" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDCAUC" ) ) ) ;
