...
User Function AUTR002(cPar1, cPar2, k___Filial, k___Observa)
    ...
    aImpostos := U_AUTOM346(k___Filial, cPar2)
...
//          nDiferencial := U_AUTOM208( aPSolic, TMPO->ADY_CODIGO, TMPO->ADY_LOJA, TMPO->ADY_FRETE, IIF(TMPO->ADZ_MOEDA == "1", 1, 2), "I", cProp1, TMPO->ADZ_TOTAL )
...
//      nSolRet := U_AUTOM208( aPrdSol, cEntCod, cLojEnt, nFrtVal, 1, "T", cProp1, TMPO->ADZ_TOTAL )
//      xRetiR := nSolRet
...
//      nSolRet := U_AUTOM208( aPrdSol, cEntCod, cLojEnt, nFrtVal, 2, "T", cProp1, TMPO->ADZ_TOTAL )
//	    xRetiD := nSolRet
