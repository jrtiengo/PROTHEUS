...
// Data......: 22/01/2011                                                                                     ##
// Descrição.: IMPRESSÃO PROPOSTA COMERCIAL                                                                   ##
...
User Function AUTR002(cPar1, cPar2, k___Filial, k___Observa)
    ...
    // ###########################################################################
	// Cria os objetos de fontes que serão utilizadas na impressão do relatorio ##
	// ###########################################################################
    ...
    // ##########################################################################################
    // Carrega o Array aImpostos com o cálculo do Difal para os produtos da proposta comercial ##
    // ##########################################################################################
    aImpostos := U_AUTOM346(k___Filial, cPar2, cRevisao)
	...
	Do While cNumPar <= MV_PAR04
        ...
        // ###########################################################
        // Verifica se existe mensagem parametrizada para impressão ##
        // ###########################################################
...
Static Function Cabecalho()
    ...
    // ###########################################
    // Identificação das Empresas da Automatech ##
    // ###########################################
    ...
    // ###################################################################################
    // Pesquisa Nº da Oportunidade, Proposta Comercial e Data de Emissão para Impressão ##
    // ###################################################################################
    DbSelectArea("AD1")
	DbSetOrder(1)
    ...
    If !Empty(Alltrim(T_DETALHES->ADY_TPFRET))
       ...
       If T_DETALHES->ADY_FRETE <> 0
          // ################################################################################################
          // Jean Rehermann - 07/02/2014 - Para uso no AUTOM208 (ICMS Solidário - Diferencial de alíquota) ##
          // ################################################################################################
    ...
    // #########################################################################
    // Imprime o cabeçalho do relatório conforme o parâmetro Imprime Garantia ##
    // #########################################################################
    If lGarantia == .T.
