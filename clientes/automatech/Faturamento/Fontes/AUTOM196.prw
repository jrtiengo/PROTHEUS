...
//             que estão em lista de preços e estão com Status = E e que não  pos- *
//             sui mais estoque na Companhia.                                      *
//**********************************************************************************

User Function AUTOM196()
   ...
   WHILE !T_PRODUTOS->( EOF() )
      ...
      aAdd( aProdutos, { ALLTRIM(T_PRODUTOS->DA1_CODTAB) ,;
   ...
   @ C(025),C(187) Say "Relação de produtos com Tipo Registro = E e estão sem estoque para venda na Companhia" Size C(200),C(008) COLOR CLR_BLACK PIXEL OF oDlgX
...
Static Function xExcdaLista(_Tabela, _Item, _Produto) 
