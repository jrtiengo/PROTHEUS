...
// Data......: 16/01/2018                                                          ##
// Objetivo..: Emissão do relatório de Produtos em Demonstração por Vendedor II    ##
// ##################################################################################
...
//   EndCase
   ...
   // Cria o List de Grupos para selecção
...
User Function AUTOMR81()   
   ...
   @ C(180),C(081) Button "Relatório"     Size C(030),C(012) PIXEL OF oDlg ACTION( I_DEMONSTRACAO( dData01, dData02, cComboBx1, cComboBx2, cComboBx3, cComboBx4, cComboBx5, cCliente, cLoja, cProduto, cFornece, cFloja, "R" ))
            ...
            If !T_DEMO->( EOF() )
               ...
               While !T_DEMO->( EOF() )      
                  ...
                  aAdd( aSaida, {xComboBx2         ,; // 01 - Tipo de Pesquisa (Em Terceiros)
                                 ...
                                 T_DEMO->D2_EMISSAO,; // 08 - Data de Emissão da Nota Fiscal
                                 ...
                                 Substr(T_DEMO->D2_ITEM,03,02),; // 15 - Ítem do Produto
                                 T_DEMO->B1_DESC   ,; // 16 - Descrição  I do Produto
                                 T_DEMO->B1_DAUX   ,; // 17 - Descrição II do Produto
...
// ASORT(aSaida,,,{ | x,y | x[1] + x[2] < y[1] + y[2] } )
   ...
   Processa( {|| IDEMONSTRACAO(Cabec1,Cabec2,Titulo,nLin) }, "Aguarde...", "Gerando Relatório",.F.)
