...
// Private ___Filial    := cFilAnt
   ...
   If T_TIPOVENDE->( EOF() )
      MsgAlert("Usuário não configurado como Vendedor. Entre em conttao com o seu supervisor de área.")
      Return(.T.)
   Endif
...
Static Function TIPO_DE_XML()
   ...
   @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(130),C(026) PIXEL NOBORDER OF oDlgXML
...
Static Function TIPO_DE_DANFE()
   ...
   @ C(002),C(005) Jpeg FILE "logoautoma.bmp"                 Size C(130),C(026) PIXEL NOBORDER OF oDlgDNF
   @ C(033),C(005) Button "DANFE pelo programa do Sistema"    Size C(130),C(012) PIXEL OF oDlgDNF ACTION( XSTSDANFE() )
   @ C(046),C(005) Button "DANFE pelo Web Service (Gratuíto)" Size C(130),C(012) PIXEL OF oDlgDNF ACTION( MsgAlert("Procedimento não disponível.") )  && U_AUTOM163() )
...
Static Function ManuOportu(_Operacao, _Codigo, _Filial, _Legenda, _PropostaK)
   ...
   If _Operacao == "I"
      ...
      @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(140),C(026) PIXEL NOBORDER OF oDlgO
...
Static Function AbreOportunidade(_Tipo, _Operacao, _Codigo, _Filial, _Legenda, _PropostaK)
   ...
   @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(134),C(026) PIXEL NOBORDER OF oDlgA
   ...
   @ C(107),C(035) MsGet    oGet12    Var   cNomeVend1    Size C(235),C(009) COLOR CLR_BLACK Picture "@!"                PIXEL OF oDlgA When lChumba
   ...
   @ C(119),C(035) MsGet    oGet14    Var   cNomeVend2    Size C(235),C(009) COLOR CLR_BLACK Picture "@!"                PIXEL OF oDlgA When lChumba
   ...
   @ C(160),C(232) Button "Voltar"             Size C(037),C(012) PIXEL OF oDlgA ACTION( FechTelOpor(_Operacao))
...
Static Function FechTelOpor(_Operacao)
   ...
   Do Case
      ...
      Case Substr(cComboBx2,01,02) = "04" 
           Do Case
              // Igual
              Case Substr(cComboBx3,01,02) == "01"
                   cSql += " AND A.A1_MUN = '" + Alltrim(cString) + "'" + CHR(13)
              // Inicando
              Case Substr(cComboBx3,01,02) == "02"
                   cSql += " AND A.A1_MUN LIKE '" + Alltrim(cString) + "%'" + CHR(13)
              // Contendo
              Case Substr(cComboBx3,01,02) == "03"
                   cSql += " AND A.A1_MUN LIKE '%" + Alltrim(cString) + "%'" + CHR(13)
           EndCase                   
...
Static Function AbrPComercial(_Operacao, _Oportunidade, _xFilial, _PorOnde, _aAlegenda, _PropostaK )
   ...
   If !Empty(Alltrim(cTexto))
	  ...
	  @ C(023),C(169) Say "INCONSISTÊNCIA PARA GRAVAÇÃO"                                       Size C(092),C(008) COLOR CLR_BLACK PIXEL OF oDlgC
   	  @ C(002),C(002) Jpeg FILE "logoautoma.bmp"                                               Size C(122),C(026)                 PIXEL NOBORDER OF oDlgC
   ...
   If _Operacao == "A"
      ...
      If _PorOnde == "S"
         ...
         If Substr(cComboBx6,01,01) == "2"
    	    ...
    	    @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(126),C(026) PIXEL NOBORDER OF oDlgEnc
...
Static Function EnvMailCli(__Vendedor)
   ...
   @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(130),C(026) PIXEL NOBORDER OF oDlgMail
...
Static Function PedidoNF( _Filial, _Oportunidade, _Proposta, _NomeCliente, xx_Cliente, xx_Loja )
   ...
   @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(126),C(030) PIXEL NOBORDER OF oDlgPed
...
Static Function PedeLoca( __Loc_Tipo, __Loc_Opor, __Loc_Prop, __Loc_Clie, __Loc_Operacao)
   ...
   @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(142),C(026) PIXEL NOBORDER OF oDlgLoc
...
Static Function ACOMPAPV(ac_filial, ac_pedido, ac_vendedor, ac_cliente, ac_loja)
   ...
   Else
      ...
      @ C(002),C(002) Jpeg FILE "logoautoma.bmp" Size C(126),C(026) PIXEL NOBORDER OF oDlgAcom
...
Static Function IncNovCli()
   ...
   @ C(002),C(005) Jpeg FILE "logoautoma.bmp" Size C(123),C(026) PIXEL NOBORDER OF oDlgNcli
