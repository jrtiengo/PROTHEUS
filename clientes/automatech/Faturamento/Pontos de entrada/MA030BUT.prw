...
// ------------------------------------------------------------------------------- *
// Referencia: MA030BUT.PRW                                                        *
// Parâmetros: Nenhum                                                              *
// Tipo......: ( ) Programa  ( ) Gatilho (X) Ponto de entrada                      *
// ------------------------------------------------------------------------------- *
// Autor.....: Harald Hans Löschenkohl                                             *
// Data......: 29/12/2011                                                          *
// Objetivo..: Ponto de entrada que adiciona botões no cadastro de clientes        *
//**********************************************************************************

// Função que cria a opção de etiquetas nas Ações Relacionadas do Cadastro de Clientes
User Function MA030BUT()
    ...
    aUsButtons := {{"Mais >>>>",{||U_AUTOMR47()},"Mais >>>>"}}


//    aUsButtons := {{"Etiqueta",{||AUTOMR72()},"Etiqueta"}}
//    aUsButtons := {{"SERASA",{||AUTOMR72()},"SERASA"}}
