...
If (_lOk)
	...
	oProcess:cTo := Alltrim(_cEmail)+";cristiano@automatech.com.br;ricardo.masiel@automatech.com.br"
...
Static Function ConsultaReqPecas(cNumOrc,cSituaOS)
   ...
   cQry += "  FROM " + RetSqlName("ZZZ") + " ZZZ(NoLock) " + chr(13)
   cQry += " WHERE ZZZ.ZZZ_NUMOS   = '" + cNumOrc + "'"
