...
//             Este prograna é chamado pelo ponto de Entrada TECA450.              *
//             Imprime etiqueta pela entrada da Ordem de Serviço.                  *
//**********************************************************************************

// Função que desenha a janela
User Function AUTOMR55()
   ...
   DEFINE SBUTTON FROM C(50),C(080) TYPE 6 ENABLE OF oDlg  ACTION( AUTRE03B(nGet1,cCombobx1)  )
...
Static Function AUTRE03B(nGet1,cPorta)
