...
// Data......: 09/10/2012                                                          *
// Objetivo..: Programa de Manutenção do Cadastro de Feriados Móveis               *
//**********************************************************************************
...
User Function ESPEVE03(_Operacao, _Codigo, _Ano)
   ...
   DEFINE MSDIALOG oDlg TITLE "Cadastro de Feriados Móveis" FROM C(178),C(181) TO C(324),C(524) PIXEL
...
Static Function _SalvaMovel(_Operacao, _Codigo, _Nome, _Data, _Tempo, _Ano)
   ...
   If _Operacao == "I"
      ...
      If Empty(Alltrim(_Nome))
         MsgAlert("Descrição do Feriado não informado. Verique !!")
         Return .T.
      Endif   

      If Empty(_Data)
         MsgAlert("Data do Feriado não informado. Verique !!")
         Return .T.
      Endif   

      If Empty(Alltrim(_Tempo))
         MsgAlert("Tempo não informado. Verique !!")
         Return .T.
      Endif   
