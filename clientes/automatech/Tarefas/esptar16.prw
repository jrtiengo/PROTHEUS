...
User Function ESPTAR16(_Tarefa)

   Local lChumba := .F.

   Private aComboBx7    := {"2 - APROVADA", "3 - REPORVADA"} // Status
   Private cStatus
   ...
   DEFINE MSDIALOG oDlg TITLE "Cadastro de Tarefas - PROJETOS" FROM C(178),C(181) TO C(626),C(967) PIXEL

   @ C(003),C(005) Say "Código"              Size C(018),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(003),C(033) Say "Projeto"             Size C(018),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(004),C(176) Say "Cliente"             Size C(021),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(004),C(315) Say "Data"                Size C(018),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(004),C(359) Say "Hora"                Size C(018),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(027),C(033) Say "Título da Tarefa"    Size C(040),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(027),C(176) Say "Tipo de Tarefa"      Size C(043),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(027),C(315) Say "Usuário"             Size C(020),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(048),C(033) Say "Prioridade"          Size C(027),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(048),C(176) Say "Responsável"         Size C(033),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(048),C(315) Say "Previsão(Horas)"     Size C(039),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(073),C(033) Say "Descrição da Tarefa" Size C(051),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(124),C(189) Say "Observações gerais"  Size C(050),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(128),C(033) Say "S T A T U S"         Size C(032),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(142),C(033) Say "Prevista Para"       Size C(034),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(142),C(087) Say "Data Término"        Size C(034),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(142),C(141) Say "Data Produção"       Size C(037),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(165),C(033) Say "Solução Adotada"     Size C(044),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   @ C(209),C(033) Say "Utilize o campo Solução Adotada para envio de mensagem ao usuário." Size C(170),C(008) COLOR CLR_BLACK PIXEL OF oDlg
   ...
   @ C(036),C(033) MsGet oGet2  Var cTitulo      Size C(138),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(036),C(177) MsGet oGet11 Var cTipoTar     Size C(130),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(036),C(315) MsGet oGet12 Var cUsuario     Size C(073),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(058),C(033) MsGet oGet13 Var cPrioridade  Size C(138),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(058),C(177) MsGet oGet14 Var cResponsavel Size C(130),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(058),C(315) MsGet oGet5  Var cTempo       Size C(026),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(083),C(033) GET oMemo1   Var cTarefa      MEMO Size C(355),C(037) PIXEL OF oDlg When lChumba
   @ C(126),C(067) ComboBox cStatus Items        aComboBx7 Size C(114),C(010) PIXEL OF oDlg
   @ C(134),C(188) GET oMemo2   Var cGeral       MEMO Size C(200),C(029) PIXEL OF oDlg
   @ C(152),C(033) MsGet oGet7  Var cPrevista    Size C(040),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg
   @ C(152),C(087) MsGet oGet8  Var cTermino     Size C(040),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(152),C(141) MsGet oGet9  Var cProducao    Size C(040),C(009) COLOR CLR_BLACK Picture "@!" PIXEL OF oDlg When lChumba
   @ C(175),C(033) GET oMemo3   Var cSolucao     MEMO Size C(355),C(028) PIXEL OF oDlg

   @ C(207),C(311) Button "Salvar" Size C(037),C(012) PIXEL OF oDlg ACTION( __AprovaTar() )
   @ C(207),C(351) Button "Voltar" Size C(037),C(012) PIXEL OF oDlg ACTION( oDlg:End() )
...
Static Function __AprovaTar()
   ...
   If DbSeek(xfilial("ZZG") + cCodigo)
      ...
      If !Empty(T_USUARIO->ZZA_EMAI)
         ...
         cEmail += chr(13) + chr(10)   
         cEmail += "Sua solicitação via Tarefa nº " + Strzero(int(val(cCodigo)),6) 
         cEmail += chr(13) + chr(10)
