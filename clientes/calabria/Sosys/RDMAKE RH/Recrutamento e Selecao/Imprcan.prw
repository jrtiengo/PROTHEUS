...
cQuery += " AND   QD.QD_FILIAL >=   '" + FilialDe       + "' "//veja que relatorio utilizar o mesmo filtro de filial tanto para SQG quanto para SQD
cQuery += " AND   QD.QD_FILIAL <=   '" + FilialAte      + "' "
cQuery += " AND   QD.QD_FILIAL LIKE '" + AllTrim(SQG->QG_FILIAL) + "%' AND QD.D_E_L_E_T_ <> '*' "
